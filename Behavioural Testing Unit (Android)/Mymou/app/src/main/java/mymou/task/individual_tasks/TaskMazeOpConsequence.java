...
public class TaskMazeOpConsequence extends Task {

    // Debug
    public static String TAG = "TaskMazeOpConsequence";
    ...
    private void assignObjects() {
        ...
        int minGridScale = cueSize + (cueSize/100)*150; // Minimum separation is 200 pixels
        ...
        int offsetX = (screenSize.x - usableWidth) / 2 + 100; // Center horizontally in the usable width
        int offsetY = (screenSize.y - usableHeight)/2 + 450; //gridHeight; //200; //220; //315 +350; // Position the bottom row 75 pixels from the bottom
