...
public class TaskMaze3x3 extends Task {
    ...
    private void assignObjects() {
        ...
        int offsetY = (screenSize.y - usableHeight) + (gridHeight / 8); //220; //315 +350; // Position the bottom row 75 pixels from the bottom
